...
const sidebar = () => {
  ...
  const navItems = [
    ...
    { icon: <FaUserDoctor className=" h-4 w-4" />, label: 'Patients', link: 'patient' },
    ...
    { icon: <MdDateRange className=" h-4 w-4" />, label: 'Schedule', link: 'schedule' },
  ];
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent side="top" className="flex-col  shadow-lg border rounded-md">
                <DropdownMenuItem className="p-0 text-sm text-gray-700 hover:bg-[#f6fff8]">
                  <span className='w-full py-1 px-2'><Link href={"/doctor/profile"} >Profile</Link></span>
                </DropdownMenuItem>
