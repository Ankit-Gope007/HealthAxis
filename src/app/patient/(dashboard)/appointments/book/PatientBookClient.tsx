...
type Props = {
    doctors: DoctorLightInfo[];
    patientId: string;
}


const PatientBookClient = ({ doctors, patientId }: Props) => {
    ...
    const selectedDoctorDetails = doctors.find(doctor => doctor.id === selectedDoctor?.toString());
...
export default PatientBookClient;
